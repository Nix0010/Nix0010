...
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=18&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=500&lines=Construyo+sistemas+web+completos;Arquitecturo+bases+de+datos+robustas;Especialista+en+PostgreSQL+%2B+TypeScript;Siempre+aprendiendo+nuevas+tecnologías" alt="Typing SVG" />
</div>
...
alias:      Nix0010
enfoque:    Full-Stack + Database Architecture
stack:
  - TypeScript / JavaScript
  - React + Node.js + Express
  - PostgreSQL + MySQL
  - Prisma + Drizzle + PL/pgSQL
  - Docker + Git
...
<p>Plataforma full-stack para torneos deportivos: brackets, rankings en tiempo real, avance automático de ganadores y exportación a PDF.</p>
<p>
...
<p>App full-stack con rutinas personalizadas, gamificación con logros, marketplace de contenido y arquitectura modular con API tipada end-to-end.</p>
<p>
...
<p>Roles con mínimo privilegio, vistas seguras para PII, triggers de auditoría con JSONB y esquema de backup PITR sobre PostgreSQL.</p>
<p>
...
<p>Modelo de datos para estudiantes, tareas, horarios y calificaciones. Scripts SQL completos, documentación y diagramas entidad-relación.</p>
<p>
<img src="https://skillicons.dev/icons?i=postgres&theme=dark" height="30" />
</p>
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:58a6ff,50:1a1f2e,100:0d1117&height=100&section=footer" />
</div>
